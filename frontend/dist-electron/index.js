...
const __vite_glob_0_23 = `-- 024_default_admin.sql\r
-- Actualiza las credenciales del admin por defecto al correo y contraseña\r
-- definitivos para Mangueras del Sur.\r
-- Password: "Manguerasdelsur*" → SHA-256\r
\r
UPDATE users\r
   SET email         = 'manguerasdelsur@admin.local',\r
       password_hash = '40d07658fcb540891697c6e7a8504cce32ac1951b4c1e06f2ec830bf564ee45f'\r
 WHERE id = 1;\r
`;
...
const __vite_glob_0_25 = `-- 026_default_company.sql\r
-- Seed del cliente "Empresa Genérica". id=2 reservado como fallback cuando\r
-- el tipo de cliente es "Empresa" pero no se selecciona una empresa específica.\r
-- Mismo patrón que id=1 (Consumidor Final). No borrar.\r
INSERT OR IGNORE INTO customers (id, nit, name) VALUES (2, 'CF', 'Empresa Genérica');\r
`;
...
const __vite_glob_0_27 = `-- 028_default_category.sql\r
-- Seed de la categoría genérica "00-FABRICACION". id=1 reservado como categoría\r
-- del sistema. Mismo patrón que id=1 (Consumidor Final) en clientes. No borrar.\r
INSERT OR IGNORE INTO categories (id, name) VALUES (1, '00-FABRICACION');\r
`;
...
const __vite_glob_0_29 = `-- 030_nav_visibility.sql\r
-- Visibilidad del menú lateral por rol no-admin.\r
-- Admin siempre ve todo; este JSON controla los demás roles.\r
-- Valores iniciales = comportamiento previo al feature.\r
INSERT OR IGNORE INTO settings (key, value, type, category, description) VALUES (\r
  'nav_visibility',\r
  '{"pos":{"cashier":true,"mechanic":true,"warehouse":true},"history":{"cashier":true,"mechanic":true,"warehouse":true},"inventory":{"cashier":true,"mechanic":true,"warehouse":true},"clients":{"cashier":false,"mechanic":false,"warehouse":false},"reports":{"cashier":false,"mechanic":false,"warehouse":false},"cash":{"cashier":false,"mechanic":false,"warehouse":false},"purchases":{"cashier":false,"mechanic":false,"warehouse":false},"receivables":{"cashier":false,"mechanic":false,"warehouse":false},"quotes":{"cashier":false,"mechanic":false,"warehouse":false},"expenses":{"cashier":false,"mechanic":false,"warehouse":false},"suppliers":{"cashier":false,"mechanic":false,"warehouse":false}}',\r
  'json',\r
  'access',\r
  'Visibilidad del menú lateral por rol'\r
);\r
`;
  ...
  return (...args) => {
    try {
      ...
      if (!(err && typeof err === "object" && "code" in err)) {
        console.error(...oo_tx$1(`3829694428_28_8_28_53_11`, "[ipc] unexpected error:", err));
      }
...
function registerCustomersIpc(service) {
  ...
  ipcMain$b.handle("customers:get-system", wrap(() => service.getSystemCustomers()));
}
const SALE_COLUMNS = `
...
function registerSalesIpc(service) {
  ...
  ipcMain$a.handle("sales:list-all-items", wrap(() => service.listAllItems()));
...
function registerCashIpc(service) {
  ...
  ipcMain$7.handle("cash:list-all-movements", wrap(() => service.listAllMovements()));
...
async function runBackup(db) {
  ...
  console.log(...oo_oo$1(`3346573374_65_2_65_75_4`, `[backup] OK → ${filename} (${(size / 1024).toFixed(1)} KB)`));
...
function startBackupSchedule(db, intervalHours = 720, maxCopies = 10) {
  ...
  setTimeout(() => runBackup(db).catch((err) => (
    /* eslint-disable */
    console.error(...oo_tx(`3346573374_113_46_113_91_11`, "[backup] error inicial:", err))
  )), 6e4);
  ...
  _timer = setInterval(() => {
    if (Date.now() - lastBackup >= intervalMs) {
      ...
      runBackup(db).catch((err) => (
        /* eslint-disable */
        console.error(...oo_tx(`3346573374_121_33_121_80_11`, "[backup] error periódico:", err))
      ));
    }
  }, 36e5);
  console.log(...oo_oo$1(`3346573374_125_2_125_101_4`, `[backup] scheduler activo — intervalo: ${intervalHours} h · máx: ${maxCopies} copias`));
}
async function restoreFromFile(db, srcPath) {
  ...
  console.log(...oo_oo$1(`3346573374_155_2_155_86_4`, `[backup] restaurado desde ${srcPath} → seguridad en ${safetyFilename}`));
...
function bootstrap() {
  ...
  console.log(...oo_oo(`1552193797_98_2_98_80_4`, "[migrator] applied:", result.applied, "skipped:", result.skipped));
  ...
  ipcMain.handle("cloud:apply-pull", (_e, data) => {
    try {
      const results = {};
      if (Array.isArray(data == null ? void 0 : data.products) && data.products.length > 0) {
      ...
      if (Array.isArray(data == null ? void 0 : data.customers) && data.customers.length > 0) {
      ...
      if (Array.isArray(data == null ? void 0 : data.categories) && data.categories.length > 0) {
