  ...
  return (...args) => {
    try {
      ...
      if (!(err && typeof err === "object" && "code" in err)) {
        console.error(...oo_tx$3(`755487567_28_8_28_53_11`, "[ipc] unexpected error:", err));
      }
...
function mergeRecords(tableName, remoteRecords = []) {
  ...
  remoteRecords.forEach((remote) => {
    ...
    try {
      ...
      console.error(...oo_tx$2(`3048593903_124_6_124_81_11`, `Error merging record id=${remote.id} in ${tableName}:`, err));
      stats.skipped++;
    }
  });
  return stats;
...
function getNextId(tableName) {
  ...
  try {
    ...
    console.error(...oo_tx$1(`2519684651_161_4_161_74_11`, `Error obteniendo siguiente ID para ${tableName}:`, err));
    return 1;
  }
}
function oo_cm$2() {
